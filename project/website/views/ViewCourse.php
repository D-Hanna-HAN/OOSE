    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <input name="name" readonly type="text" class="form-control" id="name" readonly placeholder="name"
                    value="<?= $template["name"] ?>">
            </div>

            <div class="form-group">
                <label for="description">description</label>
                <input name="description" readonly type="text" class="form-control" id="description" readonly
                    placeholder="description" value="<?= $template["description"] ?>">
            </div>
            <div class="form-group">
                <label for="start_date">start date</label>
                <input name="startDate" readonly type="text" class="form-control" id="start_date" readonly
            ...
            <table class="table table-bordered">
                ...
                if (is_array($exams)): foreach ($exams as $exam):
                        ...
                        <tr>
                            ...
                            <td>
                               <?= ($exam["type_exam"] == 0) ? "written" : "practical"; ?>
                            </td>
                        </tr>
                        <?php
                    endforeach;
